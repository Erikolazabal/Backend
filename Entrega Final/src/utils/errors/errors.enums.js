export const ErrorsName = {
    ...
    DOCUMENTS_ERROR: 'Error de documentos',
}
...
export const ErrorsCause = {
    ...
    DOCUMENTS_ERROR: 'Falta de documentos del usuario',
}
...
export const ErrorsMessage = {
    ...
    DOCUMENTS_ERROR: 'Falta uno o más documentos del usuario (ID, dirección, cuenta).',
}